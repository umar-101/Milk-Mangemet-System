"""
Django settings for milkms project.
...
SECRET_KEY = 'django-insecure-c90a)rau&^m()x@gn*jmu@5l1^^-38l9x9+2^+w6t&iuw04r4t'
...
WSGI_APPLICATION = 'milkms.wsgi.application'
